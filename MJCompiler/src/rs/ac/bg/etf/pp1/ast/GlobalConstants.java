...
public class GlobalConstants extends DeclarationList {

    private DeclarationList DeclarationList;
    private ConstDecl ConstDecl;

    public GlobalConstants (DeclarationList DeclarationList, ConstDecl ConstDecl) {
